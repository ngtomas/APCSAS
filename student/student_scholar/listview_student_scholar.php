...
//****************************************************************************************
require 'path.php';
init_cobalt('View student scholar');

$page_title       = 'ListView: %%';
$db_subclass      = 'student_scholar';
$html_subclass    = 'student_scholar_html';
$arr_pkey_name    = array('student_scholar_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add student scholar';
$edit_link        = 'Edit student scholar';
$delete_link      = 'Delete student scholar';
$view_link        = 'View student scholar';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_student_scholar.php';
$edit_page        = 'edit_student_scholar.php';
$delete_page      = 'delete_student_scholar.php';
$view_page        = 'detailview_student_scholar.php';
$csv_page         = 'csv_student_scholar.php';
$report_page      = 'reporter_student_scholar.php';
