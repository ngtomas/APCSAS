...
//****************************************************************************************
require 'path.php';
init_cobalt('View course');

$page_title       = 'ListView: %%';
$db_subclass      = 'course';
$html_subclass    = 'course_html';
$arr_pkey_name    = array('course_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add course';
$edit_link        = 'Edit course';
$delete_link      = 'Delete course';
$view_link        = 'View course';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_course.php';
$edit_page        = 'edit_course.php';
$delete_page      = 'delete_course.php';
$view_page        = 'detailview_course.php';
$csv_page         = 'csv_course.php';
$report_page      = 'reporter_course.php';
